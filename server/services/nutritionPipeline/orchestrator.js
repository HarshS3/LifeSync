    ...
    if (computedDish && canonicalId) {
      nutrientGraph = await buildAndStoreNutrientGraphFromTotals({
        ...
        totals: {
          ...
          potassium: computedDish.nutrition.potassium_mg,
          iron: computedDish.nutrition.iron_mg,
          calcium: computedDish.nutrition.calcium_mg,
          vitaminB: computedDish.nutrition.vitaminB_mg,
          magnesium: computedDish.nutrition.magnesium_mg,
          zinc: computedDish.nutrition.zinc_mg,
          vitaminC: computedDish.nutrition.vitaminC_mg,
          omega3: computedDish.nutrition.omega3_g,
