# Graph Report - LifeSync  (2026-05-24)

## Corpus Check
- 357 files · ~355,951 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1308 nodes · 1959 edges · 68 communities detected
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 148 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cada8b31`
...
- `OverviewTab()` --calls--> `useTheme()`  [INFERRED]
  client/src/components/Gym/OverviewTab.jsx → App/constants/Theme.js
- `StepsTab()` --calls--> `useTheme()`  [INFERRED]
  client/src/components/Gym/StepsTab.jsx → App/constants/Theme.js
- `GymTracker()` --calls--> `useTheme()`  [INFERRED]
  client/src/components/GymTracker.jsx → App/constants/Theme.js

## Communities (228 total, 15 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.04
Nodes (4): ExerciseHistoryPage(), HabitTracker(), AuthProvider(), useAuth()

### Community 1 - "Community 1"
Cohesion: 0.08
Nodes (35): GymTracker(), useWorkout(), WorkoutProvider(), OverviewTab(), normalizeTargetKey(), normExerciseName(), rollupTargetToRegion(), targetsForExercise() (+27 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (30): compositionEntryHasData(), createEmptyBodyComposition(), emptySegmental(), hydrateCompositionFromServer(), mergeCompositionStateFromApi(), normalizeBodyCompositionForSave(), normalizeMeasurementsForSave(), generateAiSuggestion() (+22 more)
...
Cohesion: 0.07
Nodes (17): AnimatedCard(), createEmptyFoodRow(), NutritionTracker(), createEmptyFoodRow(), fmt(), formatServingDisplay(), frontendEvaluateInteractions(), generateCGMData() (+9 more)

### Community 6 - "Community 6"
Cohesion: 0.14
Nodes (20): ExerciseDetailScreen(), CalendarScreen(), ChatScreen(), InsightsScreen(), NutritionScreen(), HeatmapScreen(), WorkoutDetailScreen(), ProgressionScreen() (+12 more)
...
Cohesion: 0.12
Nodes (19): Index(), MacroIndicator(), styles(), MuscleHeatmap(), styles(), SkeletonDashboard(), SkeletonLoader(), SkeletonNutrition() (+11 more)
...
Cohesion: 0.12
Nodes (13): dayKeyFromDate(), normalizeToLocalStartOfDay(), pad2(), triggerDailyLifeStateRecompute(), getEmbedding(), endOfDay(), getCachedEmbedding(), NutritionAgentSession (+5 more)

### Community 15 - "Community 15"
Cohesion: 0.14
Nodes (19): avg(), buildSignal(), chooseSummaryState(), clamp01(), computeDailyLifeState(), countFinite(), hashInputs(), moodEnumTo01() (+11 more)
...
Cohesion: 0.16
Nodes (16): computeRecipeTotals(), normalizeKey(), searchLocalFoods(), standardizeNutrients(), buildMealObject(), buildRuleExplanation(), labelDiabetes(), labelGutHealth() (+8 more)
...
Cohesion: 0.18
Nodes (7): formatTime(), RestTimer(), ActiveWorkoutSession(), ActiveWorkoutView(), ActiveWorkoutScreen(), RestTimer(), SwipeableRow()
...
Cohesion: 0.22
Nodes (4): ThemeProvider(), useThemeContext(), SettingsScreen(), ProfileScreen()
...
Cohesion: 0.33
Nodes (4): DashboardScreen(), QuickTile(), StatChip(), MetricSlider()
...
- **Why does `useAuth()` connect `Community 0` to `Community 1`, `Community 2`, `Community 36`, `Community 5`, `Community 6`, `Community 40`, `Community 12`, `Community 46`, `Community 50`, `Community 51`, `Community 58`, `Community 29`?**
  _High betweenness centrality (0.183) - this node is a cross-community bridge._
- **Why does `toNum()` connect `Community 2` to `Community 7`?**
  _High betweenness centrality (0.157) - this node is a cross-community bridge._
- **Are the 51 inferred relationships involving `useTheme()` (e.g. with `Index()` and `CalendarScreen()`) actually correct?**
  _`useTheme()` has 51 INFERRED edges - model-reasoned connections that need verification._
