    <Box>
      ...
      <Tabs value={activeTab} onChange={(e, v) => setActiveTab(v)} sx={{ mb: 3, '& .MuiTab-root': { textTransform: 'none', fontWeight: 500, color: '#6b7280' }, '& .Mui-selected': { color: '#171717 !important' }, '& .MuiTabs-indicator': { bgcolor: '#171717' } }}>
        <Tab label="Daily Log" />
